...
package com.dzbkq.bmapcluster.cluster.agl;


import com.baidu.mapapi.model.LatLng;
import com.dzbkq.bmapcluster.cluster.Bounds;
...
import com.dzbkq.bmapcluster.cluster.StaticCluster;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    private double distanceSquared(Pointd a, Pointd b) {
        return (a.x - b.x) * (a.x - b.x) + (a.y - b.y) * (a.y - b.y);
    }

    private Bounds createBoundsFromSpan(Pointd p, double span) {
